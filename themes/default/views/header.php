                ...
                <div id="sidebar-left" class="col-lg-2 col-md-2">
                    <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                        <ul class="nav main-menu">
                            ...
                            <?php if ($Owner || $Admin) { ?>
                                    ...
                                    <ul>
                                        ...
                                        <li id="system_settings_units">
                                            <a href="<?= site_url('system_settings/units') ?>">
                                                <i class="fa fa-wrench"></i><span class="text"> <?= lang('units_of_measure'); ?></span>
                                            </a>
                                        </li>
                                ...
                                <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                    ...
                                    <ul>
                                        <?php if ($Owner) { ?>
                                            <li id="billers_index">
                                                <a class="dropmenu" href="<?= site_url('billers'); ?>">
                                        ...
                                        <li id="suppliers_index">
                                            ...
                                            <ul>
		                                        ...
		                                        <li id="products_import_csv" class="sub_navigation">
		                                            <a class="submenu" href="<?= site_url('suppliers/import_csv'); ?>">
		                                                <i class="fa fa-file-text"></i>
		                                                <span class="text"> <?= lang('import_suppliers'); ?></span>
		                                            </a>
		                                        </li>
                                        ...
                                        <li id="customers_index">
                                            ...
                                            <ul>
                                            	...
                                            	<li id="customers_index">
		                                         ...
		                                         <li id="products_import_csv" class="sub_navigation">
		                                            <a class="submenu" href="<?= site_url('customers/import_csv'); ?>">
		                                                <i class="fa fa-file-text"></i>
		                                                <span class="text"> <?= lang('import_customers'); ?></span>
		                                            </a>
		                                        </li>
                                            ...
                                            <ul>
                                            	...
                                            	<li id="transfers_add">
		                                            <a class="submenu" href="<?= site_url('transfers/add'); ?>">
		                                                <i class="fa fa-plus-circle"></i>
		                                                <span class="text"> <?= lang('add_product_transfer'); ?></span>
		                                            </a>
		                                        </li>
                                            </ul>
                                        </li>
                                ...
                                <li class="mm_sales mm_sale_order <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li id="pos_sales">
                                            <a class="dropmenu" href="<?= site_url('pos/sales'); ?>">
                                                <i class="fa fa-filter"></i>
                                            ...
                                            <ul>
                                                ...
                                                <li id="add_pos_sales" class="sub_navigation">
                                                    ...
                                                    <?php } ?>
                                                            <li id="reports_inventory_inout">
                                                                <a href="<?= site_url('reports/inventory_inout') ?>">
                                                                    <i class="fa fa-barcode"></i><span class="text"> <?= lang('product_valuation_summary'); ?></span>
                                                                </a>
                                                            </li>
                                                            <li id="reports_inventory_valuation_detail">
                                                                <a href="<?= site_url('reports/inventory_valuation_detail') ?>">
                                                                    <i class="fa fa-barcode"></i><span class="text"> <?= lang('product_valuation_detail'); ?></span>
                                                                </a>
                                                            </li>
							...
							<?php } ?>
                                <?php if ($GP['accounts-index'] || $GP['account-list_receivable'] || $GP['account-list_ar_aging'] || $GP['account-ar_by_customer'] || $GP['account-bill_receipt'] || $GP['account-list_payable'] || $GP['account-list_ap_aging'] || $GP['account-list ap a'] || $GP['account-bill_payable'] || $GP['account-list_ac_head'] || $GP['account-list_customer_deposit'] || $GP['account-list_supplier_deposit'] || $GP['account_setting']) { ?>
                                    <li class="mm_account">
                                        <a class="dropmenu" href="#">
                                            <i class="fa fa-book"></i>
                                            <span class="text"> <?= lang('manage_accounts') ?></span>
                                        ...
                                        <ul>
                                            ...
                                            <?php } ?>
                                            <?php if ($GP['account-list ap a']) { ?>
                                                <!--<li id="account_list ap a">
                                                    <a class="submenu" href="<?/*= site_url('account/list ap a'); */?>">
                                                        <i class="fa fa-list"></i><span class="text"> <?/*= lang('list ap a'); */?></span>
                                                    </a>
                                                </li>-->
                                            <?php } ?>
